...
void Help(){  //Le imprime por pantalla al usuario todas las entradas posibles del programa 
	printf("\nLISTA DE COMANDOS:\n");
...
void ErrorCommand(){  //Error en la linea de comando relacionado a los argumentos dados por el usuario
